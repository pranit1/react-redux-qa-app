...
const initialState = {
  isAsync:false,
  posts:[
  { id: '1', question: 'Can i add my own questions?', answer: 'Yes, Of course!' },
  { id: '2', question: 'How to add a question', answer: 'Just use the form below' }
  ],
  err: null,
  status: 'idle'
}
...
const qaSlice = createSlice({
  ...
  reducers: {
    ...
    postDeleted(state, action) {
        ...
        state.posts = [ ...state.posts.slice(0, index),
...
export const { postAdded, postUpdated, postDeletedAll,postDeleted, postSorted , postIsAsync} = qaSlice.actions
