...
const onSaveAsyncPostClicked = async () => {
  if (canSave) {
      try {
          ...
          await dispatch(addNewPostDelay({ id:nanoid(), question, answer})).unwrap()
          setQuestion('')
          setAnswer('')
      } catch (err) {
  ...
  return (
    <section>
        ...
        <Box
          ...
          <form>
            <Typography data-testid="create-new-question" className="tooltip"  variant="h5" component="div" gutterBottom>
              Create a new Question
              <span className="tooltiptext">Here you can create new questions and their answers</span>
            </Typography> 
            <Grid container spacing={2}>
              <Grid item xs={12} >
                <Typography className="question-header" textAlign="left" variant="subtitle1" component="div" gutterBottom>
                  Question
                </Typography>
                <TextField 
                  fullWidth
              ...
              <Grid item xs={12} >
                <Typography className="answer-header" textAlign="left" variant="subtitle1" component="div" gutterBottom>
                  Answer
                </Typography>
                <TextareaAutosize
                  style={{width:'100%'}}
